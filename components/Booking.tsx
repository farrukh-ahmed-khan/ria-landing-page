  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          variants={fadeUp}
          className="text-[0.85rem] text-white/75 leading-relaxed mb-10 max-w-md mx-auto"
        >
          Available for keynote speaking, brand collaborations, panels, event
          hosting, workshops, and luxury experiences at the intersection of AI
          and culture.
        </motion.p>
        ...
        >
          <motion.a
            href="mailto:send2lav@gmail.com"
        ...
        <motion.p
          variants={fadeUp}
          className="mt-8 text-[0.75rem] text-white/50"
        >
          Or email:{" "}
          <a
            href="mailto:send2lav@gmail.com"
          ...
          &nbsp;·&nbsp; Instagram:{" "}
          <a
            href="https://instagram.com/lav_271"
            target="_blank"
